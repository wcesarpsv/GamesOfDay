...
# --- Mostrar métricas ---
stats_df_3c = pd.DataFrame(stats_3c)[["Model","Accuracy","LogLoss"]]
st.markdown("### 📊 Model Statistics (Bank Leverage – 3 Classes)")
st.dataframe(stats_df_3c, use_container_width=True)

# --- Botão para baixar modelos 3C ---
offer_models_download(all_model_files_3c)
...
if not games_today.empty:
    ...
    for idx, col in enumerate(["p_home_loss","p_home_push","p_home_win"]):
        games_today[col] = probs_home_3c[:, idx]
