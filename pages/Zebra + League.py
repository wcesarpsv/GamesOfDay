...
def create_robust_features(df):
    ...
    all_features = basic_features + derived_features + vector_features + wg_features
...
# ---------------- WG NO HISTÓRICO + ENRICH NOS JOGOS DE HOJE ----------------
if not history.empty:
    ...
    # Enriquecer os jogos de hoje com WG rolling do histórico
